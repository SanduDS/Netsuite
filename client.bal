...
public client class Client {
    ...
    isolated remote function addNewCustomer(Customer customer) returns RecordAddResponse|error{
    ...
    # + return - If success returns a RecordCreationResponse type record otherwise the relevant error
    isolated remote function addNewContact(Contact contact) returns RecordAddResponse|error{
    ...
    # + return - If success returns a RecordCreationResponse type record otherwise the relevant error  
    isolated remote function addNewInvoice(Invoice invoice) returns RecordAddResponse|error{
    ...
    # + return - If success returns a RecordCreationResponse type record otherwise the relevant error 
    isolated remote function addNewCurrency(Currency currency) returns RecordAddResponse|error{
    ...
    # + return - If success returns a RecordCreationResponse type record otherwise the relevant error 
    isolated remote function addNewSalesOrder(SalesOrder salesOrder) returns RecordAddResponse|error{
    ...
    # + return - If success returns a RecordCreationResponse type record otherwise the relevant error
    isolated remote function addNewClassification(Classification classification) returns RecordAddResponse|error {
    ...
    # + return - If success returns a RecordCreationResponse type record otherwise the relevant error
    isolated remote function addNewAccount(Account account) returns RecordAddResponse|error {
    ...
    isolated remote function deleteRecord(RecordDetail info) returns @tainted RecordDeletionResponse|error{
    ...
    isolated remote function updateCustomerRecord(Customer customer) returns @tainted RecordUpdateResponse|error {
    ...
    # + return - If success returns a RecordUpdateResponse type record otherwise the relevant error 
    isolated remote function updateContactRecord(Contact contact) returns @tainted RecordUpdateResponse|error {
    ...
    # + return - If success returns a RecordUpdateResponse type record otherwise the relevant error 
    isolated remote function updateCurrencyRecord(Currency currency) returns @tainted RecordUpdateResponse|error {
    ...
    # + return - If success returns a RecordUpdateResponse type record otherwise the relevant error 
    isolated remote function updateInvoiceRecord(Invoice invoice) returns @tainted RecordUpdateResponse|error {
    ...
    # + return - If success returns a RecordUpdateResponse type record otherwise the relevant error 
    isolated remote function updateSalesOrderRecord(SalesOrder salesOrder) returns @tainted RecordUpdateResponse|error {
    ...
    # + return - If success returns a RecordUpdateResponse type record otherwise the relevant error 
    isolated remote function updateClassificationRecord(Classification classification) returns @tainted RecordUpdateResponse|
                                                error {
    ...
    # + return - If success returns a RecordUpdateResponse type record otherwise the relevant error 
    isolated remote function updateAccountRecord(Account account) returns @tainted RecordUpdateResponse|error {
    ...
    isolated remote function searchCustomerRecord(SearchElement[] searchElements) returns @tainted Customer|error {
    ...
    # + searchElements - Details of a NetSuite record to be retrieved from NetSuite
    # + return - If success returns a json otherwise the relevant error
    isolated remote function searchTransactionRecord(SearchElement[] searchElements) returns @tainted RecordList|error {
    ...
    # + searchElements - Details of a NetSuite record to be retrieved from NetSuite
    # + return - If success returns a json otherwise the relevant error
    isolated remote function searchAccountRecord(SearchElement[] searchElements) returns @tainted Account|error {
    ...
    isolated remote function getCustomerRecord(RecordDetail RecordDetail) returns Customer|error {
    ...
    isolated remote function getContactRecord(RecordDetail RecordDetail) returns Contact|error {
        http:Request request = new;
        xml payload = check buildGetOperationPayload(RecordDetail, self.config);
        http:Response response = check doHTTPRequest(self.basicClient, GET_SOAP_ACTION, payload);
        return getContactRecordGetOperationResult(response);
    }
    ...
    isolated remote function getCurrencyRecord(RecordDetail RecordDetail) returns Currency|error {
        http:Request request = new;
        xml payload = check buildGetOperationPayload(RecordDetail, self.config);
        http:Response response = check doHTTPRequest(self.basicClient, GET_SOAP_ACTION, payload);
    ...
    # + RecordDetail - Ballerina record for Netsuite record information
    # + return - If success returns a Currency type record otherwise the relevant error
    isolated remote function getClassificationRecord(RecordDetail RecordDetail) returns Classification|error {
        http:Request request = new;
        xml payload = check buildGetOperationPayload(RecordDetail, self.config);
        http:Response response = check doHTTPRequest(self.basicClient, GET_SOAP_ACTION, payload);
    ...
    isolated remote function getSalesOrderRecord(RecordDetail RecordDetail) returns SalesOrder|error {
        http:Request request = new;
        xml payload = check buildGetOperationPayload(RecordDetail, self.config);
        http:Response response = check doHTTPRequest(self.basicClient, GET_SOAP_ACTION, payload);
